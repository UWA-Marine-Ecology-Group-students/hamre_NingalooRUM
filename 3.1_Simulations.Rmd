...
v <- read_excel("./data/03_data/attmod_base.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
  dplyr::select(-x...1 ) %>%
  distinct()

# no area model (test to see if area is causing  the issue)
# b <- read_excel("./data/03_data/attmod_noarea.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_noarea.xlsx", sheet = "v", col_names = rep("x", 7)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

# area model (not log transformed)
# b <- read_excel("./data/03_data/attmod_area.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_area.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   binary complete hex
# b <- read_excel("./data/03_data/attmod_comhex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_comhex.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   complete hex + arealog
# b <- read_excel("./data/03_data/attmod_arealog_comhex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_arealog_comhex.xlsx", sheet = "v", col_names = rep("x", 9)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   complete hex + area
# b <- read_excel("./data/03_data/attmod_area_comhex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_area_comhex.xlsx", sheet = "v", col_names = rep("x", 9)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   complete hex*arealog
# b <- read_excel("./data/03_data/attmod_arealoghex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_arealoghex.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   complete hex*arealog + arealog
# b <- read_excel("./data/03_data/attmod_arealog_arealoghex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_arealog_arealoghex.xlsx", sheet = "v", col_names = rep("x", 9)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

# complete hex*area
# b <- read_excel("./data/03_data/attmod_areahex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_areahex.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

# complete hex*area, area
# b <- read_excel("./data/03_data/attmod_area_areahex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_area_areahex.xlsx", sheet = "v", col_names = rep("x", 9)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

# complete hex*area, area
# b <- read_excel("./data/03_data/attmod_shex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_shex.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()
#   
#   # base model 5km
# b <- read_excel("./data/03_data/attmod_5kmbase.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_5kmbase.xlsx", sheet = "v", col_names = rep("x", 7)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   # 5 km comm hex (like for like compasrion with model below)
# b <- read_excel("./data/03_data/attmod_5km_commhex.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_5km_commhex.xlsx", sheet = "v", col_names = rep("x", 7)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()

#   # 1 km no shelter (like for like compasrion with model above)
# b <- read_excel("./data/03_data/attmod_1km_noshelter.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_1km_noshelter.xlsx", sheet = "v", col_names = rep("x", 7)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()
#   
 # 1 km no shelter log(area+1)
# b <- read_excel("./data/03_data/attmod_1kmlogarea_noshelter.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_1kmlogarea_noshelter.xlsx", sheet = "v", col_names = rep("x", 7)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()
#   
#   1km grid, commhes, only demersal
# b <- read_excel("./data/03_data/attmod_comhex_dem.xlsx") %>% dplyr::select(Vars, Coef)
# v <- read_excel("./data/03_data/attmod_comhex_dem.xlsx", sheet = "v", col_names = rep("x", 8)) %>%
#   dplyr::select(-x...1 ) %>%
#   distinct()
```
...
dat <- dat %>%
  ...
  mutate(hex_arealog = commhex*arealog) %>% 
  mutate(hex_area = commhex*area) %>% 
  st_drop_geometry() %>%
  as.data.frame()
```
...
# no area
     # vars <- c("travelCost", "Depth", "km_mainland", "isl_adj", "shelter")

# area
     # vars <- c("travelCost", "Depth", "area","km_mainland", "isl_adj", "shelter")

# complete hex
     # vars <- c("travelCost", "Depth", "commhex","km_mainland", "isl_adj", "shelter")

# arealog + complete hex
     # vars <- c("travelCost", "Depth", "arealog", "commhex","km_mainland", "isl_adj", "shelter")

# complete hex + area
  # vars <- c("travelCost", "Depth", "area", "commhex","km_mainland", "isl_adj", "shelter")

# complete hex*arealog
  # vars <- c("travelCost", "Depth", "hex_arealog","km_mainland", "isl_adj", "shelter")

# complete hex*arealog + arealog
  # vars <- c("travelCost", "Depth", "arealog","hex_arealog","km_mainland", "isl_adj", "shelter")
  # 
# complete hex*area
  # vars <- c("travelCost", "Depth", "area","hex_area","km_mainland", "isl_adj", "shelter")
  # 
# base model 5km
     # vars <- c("travelCost", "Depth", "arealog","km_mainland", "isl_adj")

# 5km comm hex
      # vars <- c("travelCost", "Depth", "commhex","km_mainland", "isl_adj")

# 1km no shelter
     # vars <- c("travelCost", "Depth", "commhex","km_mainland", "isl_adj")

# 1km no shelter, area log
     # vars <- c("travelCost", "Depth", "arealog","km_mainland", "isl_adj")

# 1km, comm hex, demersal only
     # vars <- c("travelCost", "Depth", "commhex","km_mainland", "isl_adj", "shelter")
