...
# data
full_dat <- read.csv("./data/02_data/2.1_dat.csv")
...
pred.vars <- c("Dem", "Depth", "km_BR", "Pelagic", "Reef", "RReef", "Lagoon", "decDuration", "centroidLat") 
...
# Plot transformations - need to run in console
  ...
  # update predictors
pred.vars <- c("log.Depth","log.km_BR", "Pelagic", "log.Reef", "log.RReef", "log.Lagoon", "sqrt.decDuration", "centroidLat") 
```
